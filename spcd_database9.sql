...
-- Copiando dados para a tabela scpd.movimento: ~28 rows (aproximadamente)
...
INSERT INTO `movimento` (`id_movimento`, `id_processo_documento`, `id_tipo_movimento`, `proc_data_entrada`, `id_orgao`, `observacoes_proc_entrada`) VALUES
	...
	(36, 21, 1, '2019-01-04', 2, 'processo recebido'),
	(37, 22, 1, '2018-12-30', 2, 'processo recebido'),
	(38, 21, 2, '2019-01-10', 8, 'Processo enviado'),
	(39, 21, 2, '2019-01-09', 8, 'Processo enviado'),
	(40, 21, 2, '2019-01-10', 8, 'Processo enviado'),
...
-- Copiando dados para a tabela scpd.usuario: ~4 rows (aproximadamente)
...
INSERT INTO `usuario` (`id_usuario`, `nome_usuario`, `cpf`, `email`, `senha`, `tentativa`, `id_orgao`, `id_nivel_usuario`, `id_situacao_usuario`) VALUES
	(1, 'Jose Luiz Garcia', '1234', 'luiz@email.com', '123456', NULL, 1, 1, 1),
	(2, 'Vinicius dos Santos', 'admin', 'vinicius@email.com', '$2y$12$YlooCyNvyTji8bPRcrfNfOKnVMmZA9ViM2A3IpFjmrpIbp5ovNmga', NULL, 1, 1, 2),
	(3, 'Thales', 'estag', 'estagiariodgi@faetec.rj.gov.br', '$2y$12$Y6EGRSmQGVB6B0qxVyata.lfC1p6OuF1vnv8y9gzQn4lWsVHlUbny', NULL, 94, 2, 2),
	(4, 'Eduardo', 'coordenador', 'eduardo@faetec', '$2y$12$Nb8xj7cIYukNLUancIxj0uaf4M.7N1tyBLX8FZXvh8boawGUbU4p2', NULL, 16, 1, 2),
	(5, 'usuario', 'teste', 'usuario@faetec.com', '$2y$12$zkebVETnYEyicX4ewpTNjeJ5wgKfUw2aASmDejD8VSMhIXJDIb6Ky', NULL, 7, 2, 2);
