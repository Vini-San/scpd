                        ...
                        <div class="box-body">
                            <div class="content bg-primary">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-sm-12 col-md-12">
                                            <input type="text" class="form-control form-control-sm" id="id_processo" name="id_processo" placeholder="<?php echo htmlspecialchars( $user["id_processo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"/>
                                            <label class="col-form-label col-form-label-sm ">TIPO DE MOVIMENTO:</label>
                                        </div>
                                        <div class="col-sm-12 col-md-12 text-black">
                                            <select class="custom-select custom-select-sm" id="id_tipo_movimento" name="id_tipo_movimento" required>
