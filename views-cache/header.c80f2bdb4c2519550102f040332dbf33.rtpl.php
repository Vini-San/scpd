        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src='/res/admin/dist/img/<?php echo getUserName(); ?>.png' class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <img src='/res/admin/dist/img/<?php echo getUserName(); ?>.png' class="img-circle" alt="User Image">
