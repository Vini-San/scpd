        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    <form role="form" action="/admin/docs/editarmovimento/<?php echo htmlspecialchars( $docs["id_documento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/update" method="post">
                        <div class="box-body">
                            <div class="col-12 col-sm-10 col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10 col-sm-5 col-md-6">
                                        <label for="nome_orgao" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $docs["nome_orgao"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>    
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-10 col-sm-5 col-md-4">
