        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    <!-- form start -->
                    <form role="form" action="/admin/updatepassword/<?php echo htmlspecialchars( $users["id_usuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
                        <div class="box-body">
                            <div class="col-12 col-sm-10 col-md-6">
                                <div class="form-group row">
                                    <div class="col-10 col-sm-5 col-md-8">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="nome_usuario" name="nome_usuario" value="<?php echo htmlspecialchars( $users["nome_usuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-10 col-sm-5 col-md-8">
