                        ...
                        <div class="col-12 col-sm-10 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-10 col-sm-6 col-md-6">
                                    <label for="nome_usuario" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $users["nome_usuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-10 col-sm-5 col-md-4">
                                ...
                                <div class="col-10 col-sm-5 col-md-6">
                                    <label for="cpf" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $users["cpf"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>    
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-10 col-sm-5 col-md-4">
                                ...
                                <div class="col-10 col-sm-6 col-md-8">
                                    <label for="email" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $users["email"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>
                                </div>
                            </div>
                            <a href="/admin/users/<?php echo htmlspecialchars( $users["id_usuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar os dados do usuário</a>
                            <a href="/admin/updatepassword/<?php echo htmlspecialchars( $users["id_usuario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Trocar Senha</a>
                        </div>
                        <div class="col-0 col-sm-10 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-12 col-md-8">
                                    <label for="id_orgao" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $users["nome_orgao"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-10 col-sm-8 col-md-3">
                                ...
                                <div class="col-12 col-sm-12 col-md-8">
                                    <label for="id_nivel_usuario" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $users["nivel"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-10 col-sm-8 col-md-3">
                                ...
                                <div class="col-12 col-sm-12 col-md-8">
                                    <label for="id_situacao_usuario" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $users["situacao"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
