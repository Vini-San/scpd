...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/admin/orgaos"><i class="fa fa-dashboard"></i> Todos Os Órgãos</a></li>
    <li><a href="javascript:window.history.go(-1)">Voltar Anterior</a></li>
    <li class="active">Consultando <?php echo htmlspecialchars( $users["nome_orgao"], ENT_COMPAT, 'UTF-8', FALSE ); ?></li>
            ...
            <div class="box-header">
              <div class="dropdown scroll">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                  ...
                  <li><a href="/admin/orgaos/<?php echo htmlspecialchars( $value1["id_orgao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/resultadopororgao"><?php echo htmlspecialchars( $value1["nome_orgao"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
                  <?php } ?>
                </ul>
              </div>
            </div>
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td></td>
                    <td><?php echo htmlspecialchars( $users["nome_orgao"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td>
