                ...
                <div class="box box-success">
                    <div class="box-body">
                        <div class="col-12 col-sm-10 col-md-6">
                            ...
                            <a href="/admin/users/<?php echo htmlspecialchars( $user["id_processo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar os dados do processo</a> 
                        </div>
