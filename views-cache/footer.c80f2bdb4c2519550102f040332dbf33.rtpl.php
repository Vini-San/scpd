<?php if(!class_exists('Rain\Tpl')){exit;}?>  <!-- Main Footer -->
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      Desenvolvido pelo DGI
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="http://www.faetec.rj.gov.br/dgi">DGI/FAETEC</a>.</strong> All rights reserved.
  </footer>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="control-sidebar-home-tab">
        <h3 class="control-sidebar-heading">Sistema de Controle de Processos e Documentos</h3>
        <ul class="control-sidebar-menu">
          <li>
            <a href="http://www.faetec.rj.gov.br/">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">FAETEC</h4>
