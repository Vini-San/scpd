                            ...
                            <div class="col-12 col-sm-10 col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10 col-sm-5 col-md-6">
                                        <label for="nome_orgao" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $processo["nome_orgao"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>    
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-10 col-sm-5 col-md-4">
                                    ...
                                    <div class="col-10 col-sm-6 col-md-8">
                                        <label for="tipo_processo" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $processo["tipo_processo"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>
                                    </div>
                                </div> 
                            </div>
                            <div class="col-0 col-sm-10 col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-8">
                                        <label for="nome_processo" class="col-form-label col-form-label-sm"><?php echo htmlspecialchars( $processo["nome_processo"], ENT_COMPAT, 'UTF-8', FALSE ); ?></label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-10 col-sm-8 col-md-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 col-md-12 text-black">
                                                <select class="btn btn-sm" id="id_orgao" name="id_orgao">
                                                    <option value="<?php echo htmlspecialchars( $movimento["id_orgao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" selected><?php echo htmlspecialchars( $movimento["nome_orgao"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
