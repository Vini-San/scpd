...
-- Copiando dados para a tabela scpd.tipo_documento: ~6 rows (aproximadamente)
...
INSERT INTO `usuario` (`id_usuario`, `nome_usuario`, `cpf`, `email`, `senha`, `tentativa`, `id_orgao`, `id_nivel_usuario`, `id_situacao_usuario`) VALUES
	...
	(6, 'andre', 'andre', 'andre@faetec.com', '$2y$12$7YdIg8.VsgpW1Ttwc28Il.J7wEUH96bi50tX0qtK7j1Ify6p4FRte', NULL, 94, 1, 2);
