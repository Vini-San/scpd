...
INSERT INTO `documento` (`id_documento`, `numero_documento`, `id_orgao`, `id_tipo_documento`, `data_inicio`, `nome_documento`, `assunto_documento`, `id_processo_documento`) VALUES
	...
	(3, 'CI DGI/FAETEC nÂ° 001/2019', 26, 2, '2018-09-13 00:00:00', 'JosÃ© das Couves', 'RelatÃ³rio Institucional do patrimonio de TI (2017 ~2018)', 27);
...
INSERT INTO `movimento` (`id_movimento`, `id_processo_documento`, `id_tipo_movimento`, `proc_data_entrada`, `id_orgao`, `observacoes_proc_entrada`) VALUES
	...
	(48, 18, 1, '2019-01-22', 16, 'processo recebido'),
	(49, 27, 1, '2019-02-01', 1, 'Processo recebido nesta data');
...
-- Copiando dados para a tabela scpd.usuario: ~7 rows (aproximadamente)
...
INSERT INTO `usuario` (`id_usuario`, `nome_usuario`, `cpf`, `email`, `senha`, `tentativa`, `id_orgao`, `id_nivel_usuario`, `id_situacao_usuario`) VALUES
	...
	(3, 'Thales', 'estag', 'estagiariodgi@faetec.rj.gov.br', '$2y$12$wRA6OOSse6E2KwhOyKJ8Pu.xQ54NgE9O7/ncyWxIeUzLC58uu2IzO', NULL, 94, 2, 2),
	...
	(8, 'Ana Paula', 'anapaula', 'anapaula@faetec.com', '$2y$12$ObZff8v4kupI9Hlc5EID..mAuZ88JXAV./Laaghj76gufrEXqaVb2', NULL, 2, 2, 2);
